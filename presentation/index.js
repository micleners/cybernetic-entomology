      ...
      >
        ...
        <Slide transition={['zoom']} bgColor="dark">
          ...
          <List style={{ marginLeft: 50 }} textColor="text">
            ...
            <ListItem>
              <AquaText>White Box:</AquaText> Call a service and assert on ORM call
            </ListItem>
            <br />
            <ListItem>
              <AquaText>Black Box:</AquaText> Check rendered DOM of component
            </ListItem>
            <ListItem>
              <AquaText>White Box:</AquaText> Test individual methods or state
            </ListItem>
          </List>
        </Slide>
        <BehaviorDrivenTesting />
